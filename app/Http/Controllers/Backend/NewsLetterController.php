...
class NewsLetterController extends Controller
{
    ...
    {
        $subscriber = Newsletter::whereId($id)->first()->delete();
    ...
    public function postCreateCampaign(Requests\sendCampaign $request)
    {
        ...
        foreach ($subscirbers as $subscirber) {
            ...
            $subscirber->notify(new sendCampaign($request->title, $request->body));
        }

        return redirect()->route('backend.newsletter.index')->with('success', 'campiagin sent successfully');
    }
}
