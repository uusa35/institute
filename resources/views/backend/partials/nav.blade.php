    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo" style="background-color: #444F5C;">
            <a href="{{ route('backend.dashboard.index') }}">
                <img src="{{ asset('storage/'.$contactusInfo->logo) }}" alt="logo" class="img-responsive"
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="{{ route('backend.publish.trans') }}"><i
                                        class="fa fa-fw fa-language"></i>publish translations</a>
                        </li>
                    </ul>
                </li>
