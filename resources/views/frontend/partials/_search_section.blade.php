    ...
    <div class="col-lg-6">
        <div>
            ...
            <div class="col-lg-12 text-center">
                ...
                <div class="col-lg-6" style="display: flex; flex-direction: column; flex: 0.5; align-content: center; justify-items: center; justify-content: center">
                    <div class="form-group">
                        <input name="first_name" class="input-lg" type="text" size="20"
                               placeholder="{{ trans('general.search_by_name') }}"/>
                    </div>
                    <button type="submit" href="#" style="border: none; background: transparent;">
                        <i class="glyphicon glyphicon-circle-arrow-left" aria-hidden="true" style="color : #1976b7; font-size: 250%"></i>
                    </button>
                </div>
                {{ Form::close() }}
                ...
                <div class="col-lg-6" style="display: flex; flex-direction: column; flex: 0.5; align-content: center; justify-items: center; justify-content: center">
                    <div class="form-group">
                        <input name="membership_id" class="input-lg" type="text" size="20"
                               placeholder="{{ trans('general.search_by_id') }}"/>
                    </div>
                    <button type="submit" href="#" style="border: none; background: transparent;">
                        <i class="glyphicon glyphicon-circle-arrow-right" aria-hidden="true" style="color : #1976b7; font-size: 250%"></i>
                    </button>
                </div>
                {{ Form::close() }}
            </div>
